...
def raise_unavailable_protocol_version():
    """
    Raises a TLSError due to a TLS version is unavailable

    :raises:
        TLSError
    """

    raise TLSError('TLS configuration failed - protocol version error')
