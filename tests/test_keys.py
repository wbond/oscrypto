...
class KeyTests(unittest.TestCase):
    ...
    def private_keys():
        return (
            ...
            ('keys/test-ec-aes128.key',        b'password123', 'ec',),
            ('keys/test-ec-der.key',           None,           'ec',),
            ('keys/test-ec.key',               None,           'ec',),
    ...
    def public_keys():
        return (
            ...
            ('keys/test-public-ec-der.key',           'ec',),
            ('keys/test-public-ec.key',               'ec',),
